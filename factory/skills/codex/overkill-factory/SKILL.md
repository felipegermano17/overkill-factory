...
- Public documentation changes touch registries, workers, phases, schemas,
  ...
  `legacy-docs/reference/factory-kernel-reference.md`.
...
- `legacy-docs/architecture/factory-v2-control-plane.md` when working on deterministic
  state, phase jumps, command/event logs, decision outbox or promotion packets.
- `legacy-docs/reference/factory-kernel-reference.md` when checking the complete public
...
- `legacy-docs/concepts/overkill-factory-method.md`,
  `legacy-docs/concepts/factory-flow.md`, `legacy-docs/concepts/operator-journey.md` and
  `legacy-docs/operations/validation-and-release.md` when aligning public docs with
  the executable repo.
