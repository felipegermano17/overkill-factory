...
class PublicSurfaceSyncTest(unittest.TestCase):
    def manifest(self) -> dict:
        return json.loads((ROOT / "legacy-docs" / "public-surface.manifest.json").read_text(encoding="utf-8"))
    ...
    def test_worker_count_drift_is_detected(self) -> None:
        ...
        self.assertIn(
            "legacy-docs/visuals/overkill-factory-map-v1.0.3.html: manifest worker count 999 does not match registry count 40",
            findings,
        )
    ...
    def test_runtime_overclaim_is_detected(self) -> None:
        findings = surface_sync.public_doc_overclaim_findings(
            "legacy-docs/visuals/overkill-factory-map-v1.0.3.html",
        ...
        self.assertEqual(
            findings,
            [
                "legacy-docs/visuals/overkill-factory-map-v1.0.3.html: public surface overclaims runtime authority",
                "legacy-docs/visuals/overkill-factory-map-v1.0.3.html: public surface overclaims runtime authority",
            ],
        )
    ...
    def test_map_fidelity_stage_node_title_drift_is_detected(self) -> None:
        ...
        self.assertIn(
            "legacy-docs/visuals/overkill-factory-map-v1.0.3.html: fidelity stage node intake title "
    ...
    def test_map_fidelity_missing_stage_output_term_is_detected(self) -> None:
        ...
        self.assertIn(
            "legacy-docs/visuals/overkill-factory-map-v1.0.3.html: fidelity stage node completion "
    ...
    def test_map_fidelity_missing_template_term_is_detected(self) -> None:
        ...
        self.assertIn(
            "legacy-docs/visuals/overkill-factory-map-v1.0.3.html: fidelity template_ref has no map coverage: "
