...
contract = load_module("status_snapshot_contract_module", "scripts/status_snapshot/status_snapshot_contract.py")
fixture_validator = load_module("status_snapshot_fixture_validator_module", "scripts/status_snapshot/validate_status_snapshot_fixtures.py")
evidence_validator = load_module("status_snapshot_evidence_validator_module", "scripts/status_snapshot/validate_evidence_refs.py")
fail_closed = load_module("status_snapshot_fail_closed_module", "scripts/status_snapshot/assert_fail_closed.py")
