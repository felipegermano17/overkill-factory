...
class SupplyChainProofTests(unittest.TestCase):
    ...
    def test_source_inventory_excludes_tmp_runtime_artifacts(self):
        with TemporaryDirectory() as tmpdir:
            ...
            with mock.patch.object(proof, "ROOT", root), mock.patch.object(proof, "REPO_ROOT", root):
    ...
    def test_source_inventory_tolerates_missing_root(self):
        ...
        with mock.patch.object(proof, "ROOT", missing), mock.patch.object(proof, "REPO_ROOT", missing):
