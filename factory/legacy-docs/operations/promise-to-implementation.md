...
> Current authority: `legacy-docs/promise-implementation-map.public.json`,
...
The canonical map is `legacy-docs/promise-implementation-map.public.json`.
...
1. Add or update the claim in `legacy-docs/promise-implementation-map.public.json`.
