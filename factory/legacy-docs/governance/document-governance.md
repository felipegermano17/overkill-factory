...
2. Current user path: `README.md`, `legacy-docs/getting-started/quickstart-hermes.md`,
   `legacy-docs/concepts/factory-flow.md`, `legacy-docs/concepts/overkill-factory-method.md`,
   `legacy-docs/concepts/operator-journey.md` and
   `legacy-docs/operations/validation-and-release.md`.
3. Generated references, especially `legacy-docs/reference/factory-kernel-reference.md`,
