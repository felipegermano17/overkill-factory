...
`legacy-docs/agents/factory-stage-agent-map.md`. It maps each canonical factory stage
...
- Conceptual role names such as Method Router, Product Experience Router,
  ...
  `legacy-docs/agents/factory-stage-agent-map.md`. They must not exist as loose Hermes
