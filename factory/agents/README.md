...
| 2 | `legacy-docs/agents/worker-profiles.md` | Operator-facing guide for every worker role. |
| 3 | `legacy-docs/agents/factory-stage-agent-map.md` | Stage-by-stage map from the factory journey to real workers. |
| 4 | `legacy-docs/agents/capability-packs.md` | Product-type coverage and pack activation rules. |
| 5 | `legacy-docs/agents/permission-model.md` | Human explanation of worker authority classes. |
...
| `legacy-docs/agents/live-agent-configuration.md` | How public worker contracts map to live Hermes profile materialization. |
| `legacy-docs/agents/hermes-profile-manifest.md` | Expected Hermes profile shape. |
| `legacy-docs/architecture/hermes-integration.md` | How Hermes, adapter hooks and worker packets fit together. |
