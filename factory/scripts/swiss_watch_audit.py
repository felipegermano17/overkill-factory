...
PROGRAM_REF = "legacy-docs/maintenance/swiss-watch-reliability-program.md"
GEAR_MATRIX_REF = "legacy-docs/maintenance/swiss-watch-gear-matrix.md"
    ...
    *,
    ...
    for phase in phases:
        ...
        checks = [
            ...
            check(
                ...
                ["legacy-docs/architecture/factory-v2-control-plane.md", "templates/factory-workflow-compiled-plan.json"],
            ...
            check(
                ...
                ["legacy-docs/factory-workflow.catalog.json", "templates/factory-workflow-compiled-plan.json"],
    ...
    dimensions = [
        ...
        check(
            ...
            ["templates/hermes-typed-block-policy.json", "legacy-docs/architecture/factory-v2-control-plane.md"],
