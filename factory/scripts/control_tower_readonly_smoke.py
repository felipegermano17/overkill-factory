...
def synthetic_runtime_snapshot(created_at: str) -> dict[str, Any]:
    return {
        ...
        "evidence_refs": ["legacy-docs/control-tower/discord-control-tower-os.md"],
...
def build_receipt(created_at: str | None = None) -> dict[str, Any]:
    ...
    receipt = {
        ...
        "evidence_refs": [
            "legacy-docs/control-tower/discord-control-tower-os.md",
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=ROOT / ".tmp" / "factory-runs" / "control-tower" / "control-tower-readonly-smoke.json",
    )
