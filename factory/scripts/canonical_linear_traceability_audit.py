...
def refs_packs() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/agents/capability-packs.md", "capability pack operator manual"),
...
def refs_security() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/security/security-control-matrix.md", "security specialist matrix"),
...
def refs_authority() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/agents/permission-model.md", "permission and authority model"),
...
def refs_runtime() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/architecture/hermes-integration.md", "Hermes integration architecture"),
...
def refs_control_tower() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/control-tower/discord-control-tower-os.md", "Discord Control Tower OS"),
...
def refs_autonomy_readiness() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/agents/factory-stage-agent-map.md", "stage 17 agent ownership"),
...
def refs_closure_summary() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/automation/worker-automation-v0.md", "closure summary operating rule"),
        ref("documentation", "legacy-docs/agents/worker-profiles.md", "evidence-reconciler closure duties"),
...
def refs_docs_standard() -> list[dict[str, str]]:
    return [
        ref("documentation", "legacy-docs/operations/validation-and-release.md", "validation and release manual"),
        ref("documentation", "legacy-docs/operations/troubleshooting.md", "operator troubleshooting manual"),
        ref("documentation", "legacy-docs/getting-started/quickstart-hermes.md", "operator quickstart"),
...
def refs_workers() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "legacy-docs/agents/worker-profiles.md", "worker profiles manual"),
        ref("documentation", "legacy-docs/agents/factory-stage-agent-map.md", "stage-to-agent map"),
...
def refs_factory_flow() -> list[dict[str, str]]:
    return [
        ref("documentation", "legacy-docs/concepts/factory-flow.md", "factory flow explanation"),
        ref("documentation", "legacy-docs/concepts/factory-flow.md", "execution flow guide"),
