...
def refs_packs() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "capability pack operator manual"),
...
def refs_security() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "security specialist matrix"),
...
def refs_authority() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "permission and authority model"),
...
def refs_runtime() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "Hermes integration architecture"),
...
def refs_closure_summary() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "closure summary operating rule"),
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "evidence-reconciler closure duties"),
...
def refs_factory_flow() -> list[dict[str, str]]:
    return [
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "factory flow explanation"),
        ref("documentation", "docs/en/02-factory-flow-and-hermes-architecture.md", "execution flow guide"),
