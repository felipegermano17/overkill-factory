...
def refs_packs() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/07-hermes-and-factory.md", "capability pack operator manual"),
...
def refs_security() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/05-evidence-and-receipts.md", "security specialist matrix"),
...
def refs_authority() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/05-evidence-and-receipts.md", "permission and authority model"),
...
def refs_runtime() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/07-hermes-and-factory.md", "Hermes integration architecture"),
...
def refs_autonomy_readiness() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/11-repository-reference.md", "stage 17 agent ownership"),
...
def refs_closure_summary() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/07-hermes-and-factory.md", "closure summary operating rule"),
        ref("documentation", "docs/en/07-hermes-and-factory.md", "evidence-reconciler closure duties"),
...
def refs_docs_standard() -> list[dict[str, str]]:
    return [
        ref("documentation", "docs/en/10-local-validation.md", "validation and release manual"),
        ref("documentation", "docs/en/10-local-validation.md", "operator troubleshooting manual"),
        ref("documentation", "docs/en/10-local-validation.md", "operator quickstart"),
...
def refs_workers() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/en/07-hermes-and-factory.md", "worker profiles manual"),
        ref("documentation", "docs/en/11-repository-reference.md", "stage-to-agent map"),
...
def refs_factory_flow() -> list[dict[str, str]]:
    return [
        ref("documentation", "docs/en/03-how-a-request-moves.md", "factory flow explanation"),
        ref("documentation", "docs/en/03-how-a-request-moves.md", "execution flow guide"),
