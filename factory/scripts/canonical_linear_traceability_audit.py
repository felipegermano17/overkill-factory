...
def refs_packs() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "capability pack operator manual"),
...
def refs_security() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "security specialist matrix"),
...
def refs_authority() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "permission and authority model"),
...
def refs_runtime() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "Hermes integration architecture"),
...
def refs_autonomy_readiness() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/uso.md", "stage 17 agent ownership"),
...
def refs_closure_summary() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "closure summary operating rule"),
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "evidence-reconciler closure duties"),
...
def refs_docs_standard() -> list[dict[str, str]]:
    return [
        ref("documentation", "docs/pt-BR/uso.md", "validation and release manual"),
        ref("documentation", "docs/pt-BR/uso.md", "operator troubleshooting manual"),
        ref("documentation", "docs/pt-BR/uso.md", "operator quickstart"),
...
def refs_workers() -> list[dict[str, str]]:
    return [
        ...
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "worker profiles manual"),
        ref("documentation", "docs/pt-BR/uso.md", "stage-to-agent map"),
...
def refs_factory_flow() -> list[dict[str, str]]:
    return [
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "factory flow explanation"),
        ref("documentation", "docs/pt-BR/linha-de-producao.md", "execution flow guide"),
