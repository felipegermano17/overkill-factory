...
def public_worker_profile_layer_ready(runtime_proofs: list[dict[str, Any]] | None) -> bool:
    ...
    return (
        ...
        and exists("legacy-docs/agents/live-agent-configuration.md")
        and exists("legacy-docs/agents/security-specialist-matrix.md")
    )
        ...
        requirements.append(
            achieved_requirement(
                ...
                [
                    ...
                    "legacy-docs/agents/security-specialist-matrix.md",
                    *(runtime_proof_refs or ["external:redacted-hermes-runtime-proof"]),
                ],
