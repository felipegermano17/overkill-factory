...
1. Read the bridge architecture before acting. Prefer
   `docs/operator/overkill-factory-bridge.md` when operating inside the public
   repo; otherwise read this plugin's
   `references/overkill-factory-bridge.md`.
...
Hermes block event, and leave dispatch to later factory gates.
