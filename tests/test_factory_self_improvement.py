...
class FactorySelfImprovementTest(unittest.TestCase):
    ...
    def test_owner_issue_intake_attaches_valid_sdlc_feedback_loop_to_actionable_candidate(self) -> None:
        ...
        self.assertEqual(loop["routing_decision"]["selected_profile"], "skill-eval-distiller")
        self.assertEqual(candidate["owner_worker"], "skill-eval-distiller")
        self.assertNotIn("factory-mechanic-loop", json.dumps(report))
