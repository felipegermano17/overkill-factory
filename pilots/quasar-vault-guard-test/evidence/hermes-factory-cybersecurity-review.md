...
3. Evidência é majoritariamente processual/estática. O arquivo evidence/hermes-security-runner-review.md está vazio; isso não bloqueia o dry pilot, mas impede tratar o pacote como review cyber completo reutilizável.
