...
3 riscos:
1. Validação não é totalmente reexecutável no pacote: `factoryctl.py` citado não existe em `/srv/hermes/home/context-lock/overkill-factory-pilot-10`.
...
Handoff:
```yaml
profile: kaxis-reviewer
task_id: quasar-vault-guard-test
source_refs:
  - /srv/hermes/home/context-lock/overkill-factory-pilot-10/quasar-vault-guard-test
