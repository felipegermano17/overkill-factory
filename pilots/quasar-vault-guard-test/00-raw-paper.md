...
We need a small KAXIS-style product for monitoring Solana vault safety before
money moves.
...
Important: KAXIS program must be Quasar, not Anchor. The onchain program should
...
any R3/R4 action. Felipe said in chat on 2026-06-05 that Codex is authorized to
