...
| --- | --- | --- |
| Is the first slice allowed to be a controlled test product? | Yes. User explicitly authorized a paper of test and full closure. | Enables dry pilot without waiting for a real real product paper. |
