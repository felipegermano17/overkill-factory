...
| S7 | `validation/quasar-product-like-proof/hermes-qvg-code-audit-summary.md` | Hermes runtime evidence | promoted for public pilot | Proves product-like Quasar build/test and bounded Auditor code-audit in a real Hermes worker. |
...
| --- | --- | --- |
| Need onchain proof vs no production program yet. | Use the public product-like Quasar target for build/test and bounded Auditor code-audit, while keeping production approval blocked. | Stronger than preflight and still honest about production limits. |
