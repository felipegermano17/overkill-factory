...
## Factory 13 Builder Pilot Addendum

This run is specifically for the builder-layer correction. The goal is to prove that product execution is routed to surface-specific builders, not to a single generic implementation worker.
