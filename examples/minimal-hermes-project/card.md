```json
{
  ...
  "project_design_system": {
    ...
    "design_system_id": "minimal-hermes-project-design-system",
    "surface_scope": ["web_app", "operator_console", "product_surface"],
    "source_contracts": {
      "product_experience_plan_ref": "examples/minimal-hermes-project/card.md#product_experience_plan",
      "product_face_packet_ref": "examples/minimal-hermes-project/card.md#product_face_packet",
  ...
  "product_face_packet": {
    ...
    "done_definition": [
      ...
      "review confirms result satisfies the project_design_system",
      "visual_quality_result is PASS or PASS_WITH_RESIDUALS with reviewer basis"
    ],
    "human_gate": {
      "required": false,
