...
Factory 11 is the public hardening baseline for the next upgrade.

The next target is Factory vFinal. See:

`docs/roadmap/factory-vfinal-upgrade-plan.md`

Factory 11 turned the previous methodology, contracts and pilot evidence into a
public-safe, durable, agent-operable production baseline.
