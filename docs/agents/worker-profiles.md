...
| `frontend-builder` | Builds screens, components and responsive UI. | F12-F13. | Product Experience Plan, Product Face packet, professional design process, paths, acceptance criteria. | `frontend_build_result`. | Self-validate Product Face. | diff refs, UI tests, state notes. | frontend tooling, browser. |
